...
export const tapacityAbi = parseAbi([
  ...
  "function createRound(uint32 durationBlocks, uint32 revealBlocks, uint16 maxPlayers, uint96 tapGrantWei) returns (uint256 roundId)",
  "function startRound(uint256 roundId, uint32 leadBlocks) payable",
  ...
  "function getRound(uint256 roundId) view returns ((address creator, uint64 startBlock, uint64 endBlock, uint64 revealEndBlock, uint32 durationBlocks, uint32 revealBlocks, uint96 tapGrantWei, uint16 maxPlayers, uint16 playerCount, uint64 totalTaps, bool settled))",
  ...
  "event RoundCreated(uint256 indexed roundId, address indexed creator, uint32 durationBlocks, uint32 revealBlocks, uint16 maxPlayers, uint96 tapGrantWei)",
