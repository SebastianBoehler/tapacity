...
export default async function HostPage({
  ...
  const initialRoundId = typeof requestedRound === "string" && /^\d+$/.test(requestedRound)
    ? requestedRound
    : undefined;
  ...
  return <HostConsole contract={contract} origin={`${protocol}://${host}`} initialRoundId={initialRoundId} />;
}
