# Monad Blitz Amsterdam Submission Process

## Steps to prepare your project repo:

1. Visit the `monad-blitz-amsterdam` repo (link [here](https://github.com/monad-developers/monad-blitz-amsterdam)) and fork it.
